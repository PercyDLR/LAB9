        ...
        <div class='container'>
            ...
            <div class="pb-5 pt-4 px-3 titlecolor">
                ...
                <div class="col col-md-4 col-sm-6">
                    <a class="btn btn-warning"
                       href="<%=request.getContextPath()%>/paises?action=crear">Agregar País</a>
                </div>
            </div>
            ...
            <div class="text-center">
                    ...
                    <form method="POST" action="<%=request.getContextPath()%>/paises?action=listar">
                        ...
                        <p>
                            <select class="form-select btn btn-outline-secondary " aria-label="Continentes"
                                    name="filter">
                ...
                <table class="table table-transparent table-hover text-center">
                    <thead class="text-white">
                        <tr>
                            ...
                            <th><a class="btn btn-dark">TAMAÑO Km^2</a></th>
                    ...
                    <tbody>
                        ...
                        <tr class="table-secondary">
                            ...
                            <td><a class="btn btn-danger"
                                   href="<%=request.getContextPath()%>/paises?action=eliminar&idP=<%=pais.getIdPais()%>">Eliminar</a>
                            </td>
                        </tr>
                        <%}%>
                    </tbody>
